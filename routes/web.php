...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::post('/users/novo', 'App\Http\Controllers\UserController@store')->name('registrar_usuario');
	Route::post('/users/editar/{id}', 'App\Http\Controllers\UserController@update')->name('alterar_usuario');
});
