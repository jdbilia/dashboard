@extends('layouts.app', ['activePage' => 'register', 'titlePage' => __('Editar Usuário')])
...
<div class="container" style="height: auto;">
  <div class="row align-items-center">
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="{{ route('alterar_usuario', ['id' => $user->id]) }}">
        @csrf
        @method('POST')
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-footer justify-content-center">
            <button type="submit" class="btn btn-primary btn-link btn-lg">{{ __('Editar Conta') }}</button>
          </div>
        </div>
      </form>
    </div>
